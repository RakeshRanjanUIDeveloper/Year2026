export const fakeVideoFetch = (url) => {
                ...
                resolve({
                    ...
                    data: {
                        videos: [{
                                ...
                                description: 'Learn the basics of React in this introductory tutorial',
                            ...
                            },
                            {
                                ...
                                description: 'Get started with JavaScript with this beginner-friendly tutorial',
