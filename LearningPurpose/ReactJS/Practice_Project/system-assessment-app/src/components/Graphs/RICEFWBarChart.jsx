...
const RICEFWBarChart = ({ activeTab }) => {
  const { setIsRightPanelOpen, incrementHierarchyStep, hierarchy, setLastStepDevelopment, setShowDropdownComponent } = useContext(MainFrameContext);
  ...
  switch (activeTab) {
    case 'summary':
      ...
      break;
    case 'system':
      dataForChart = ricefwData;
      percentage = Math.round(cleanlinessScore * 100);
      break;
    case 'deepdive':
      break;
    case 'solutions':
