...
const SetTwo = () => {
  ...
  const electronicsProducts = [
    ...
    const namee = 'Preeti' // you can put your name
    const learning = 'I am learning React JS currently at neoG Camp.'

    const myGadgetsProducts = [
        {
           id: 1,
           name: 'keyboard',
           description: 'Logitech Mechanical Keyboard',
  ...
  return (
    <React.Fragment>
      ...
      <Gadgets gadgetProducts={products} />
      <Phones electronicsProducts={electronicsProducts} />
      <Article articleTitle={title} articleContent={content} />
      <About namee={namee} heading={heading} learning={learning} />
